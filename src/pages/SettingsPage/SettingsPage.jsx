...
import {
  closeOverlayMessageAction,
  openOverlayMessageAction,
} from "../../redux/layout/layout-actions";
import {
  updateMyPasswordAtion,
  updateUserAtion,
...
const SettingsPage = () => {
    ...
    try {
      ...
      setAvatarError(
        error?.response?.data?.message ||
          "Merci de vérifier les champs renseignés."
      );
    }
  ...
  return (
    <>
      <AlertOverlayPopup>
        <p>
          Vous devez rafraichir la page pour prendre cette modification en
          compte.
        </p>
        <CustomButton
          level="primary"
      ...
      <div className="SettingsPage pageWrapWidth">
        ...
        <form
          ...
          onSubmit={(e) => handleAvatarUpdate(e, imageInput.current.files[0])}
        >
          ...
          <div className="form-group__inline-input">
            <input
              ...
              required
            />
            <CustomButton level="secondary">
              {isAvatarLoading ? "En cours..." : "Valider"}
            </CustomButton>
          </div>
        ...
        <form className="form-group" onSubmit={handleNameUpdate}>
          ...
          <div className="form-group__inline-input">
            ...
            />
            <CustomButton level="secondary">
              {isNameLoading ? "En cours..." : "Valider"}
            </CustomButton>
          </div>
        ...
        <form className="form-group" onSubmit={handlePasswordUpdate}>
          ...
          <div className="form-group">
            ...
            />
            <CustomButton level="secondary">
              {isPasswordLoading ? "En cours..." : "Valider"}
            </CustomButton>
          </div>
          {passwordError && (
            <p className="error-text">Erreur : {passwordError}</p>
          )}
        </form>
      </div>
    </>
